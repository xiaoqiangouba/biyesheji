...
var layer = {
  ...
  config: function(options, fn){
    ...
    isLayui 
      ? layui.addcss('css/static/' + options.extend)
  ...
  ready: function(callback){
    ...
    isLayui ? layui.addcss('/layer.css?v='+layer.v+ver, callback, cssname)
    : layer.link('/layer.css?v='+layer.v+ver, callback, cssname);
    return this;
  },
...
Class.pt.config = {
  type: 0,
  shade: 0.001,//2016-11-07 zhuangqian 将阴影层透明
  fixed: true,
  move: doms[1],
  title: '&#x4FE1;&#x606F;',
  offset: 'auto',
